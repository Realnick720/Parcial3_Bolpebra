...
function eliminarExitoso(resultado, e, elemento) {
  ...
  if (resultado.Success) {
    ...
    toastr.success("El Vehiculo'" + elemento.marca + " '   se ha eliminado satisfactoriamente");
  } else {
...
function confirmarEliminar(e, elemento) {
  ...
  var tipo = 'POST';
  var datos = {
    id_vehiculo: elemento.id_vehiculo
  };
  var tipoDatos = 'JSON';
...
function eventoActualizarVehiculo(input, elemento) {
  $(input).unbind('click').click(function () {
    ...
    $(modal).find(".modal-title").html('Editar Vehiculo : ' + "'" + elemento.marca + "'");
...
function mostrarEliminarVehiculo(e, elemento) {
  ...
  $(modal).find(".text-mensaje-modal").html('Esta seguro que desea eliminar el Vehiculo ' + "'" + elemento.marca + "'    ?");
...
function guardarVehiculo(id_vehiculo, elemento) {
  ...
  var tipoDatos = 'JSON';
  solicitudAjax(url, function (response) {
    guardarVehiculoExitoso(response, elemento);
  }, datos, tipoDatos, tipo);
}
...
function mostrarDatosVehiculos() {
  ...
  $.each(_datosVehiculos, function (index, elemento) {
    ...
    fila.append(col(AccionColumna(function (e) {
      mostrarEliminarVehiculo(e, elemento);
...
//# sourceMappingURL=vehiculo.dev.js.map
